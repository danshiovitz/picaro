...
if __name__ == "__main__":
    ...
    PLAYER_ID = 103
    game_id = engine.create_game(player_id=PLAYER_ID, name="Test Game", json_dir=json_dir)
    engine.add_character(game_id=game_id, player_id=PLAYER_ID, character_name="Conan", location="random", job_name="Raider")
